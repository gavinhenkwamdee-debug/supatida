    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white p-6 mb-6" style={{ border: "1px solid var(--border)" }}>
        ...
        <div className="mt-3 p-3 text-xs font-sans space-y-1" style={{ backgroundColor: "#FAF8F4", border: "1px solid var(--border)", color: "var(--muted)" }}>
          ...
          <p>• <strong>Desktop</strong> แสดงผล ratio <strong>3:1</strong> → upload <strong>1920×640px</strong></p>
          <p>• <strong>Mobile</strong> แสดงผล ratio <strong>4:3</strong> → เนื้อหาสำคัญไว้ตรงกลางรูป</p>
          <p>• รูปจะ crop ส่วนเกินโดยไม่บี้ · รองรับ JPG, PNG, WebP</p>
        </div>
      </div>
