...
const TITLE: Record<ReviewType, string> = {
  preorder: "รีวิวก่อนสั่งทำ",
  product: "รีวิวหลังซื้อสินค้า",
};
...
export default function ReviewForm({ type }: { type: ReviewType }) {
  ...
  return (
    <div className="bg-white p-6" style={{ border: "1px solid var(--border)" }}>
      <h3 className="text-xl tracking-wider mb-5" style={{ color: "var(--charcoal)" }}>{TITLE[type]}</h3>
