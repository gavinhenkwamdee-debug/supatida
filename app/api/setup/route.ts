...
interface SeedProduct {
  ...
  description: string; specifications: Specifications; images: string[]; soldOut: boolean; hidden: boolean; bestSeller: boolean; badge: string | null; igi: boolean;
}
...
const SEED_PRODUCTS: SeedProduct[] = [
  {
    ...
    images: [], soldOut: false, hidden: false, bestSeller: false, badge: null, igi: false,
  },
  {
