...
interface SeedProduct {
  ...
  description: string; specifications: Specifications; images: string[]; soldOut: boolean; hidden: boolean; bestSeller: boolean;
}
...
const SEED_PRODUCTS: SeedProduct[] = [
  {
    ...
    images: [], soldOut: false, hidden: false, bestSeller: false,
  },
  {
