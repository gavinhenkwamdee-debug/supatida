...
interface SeedProduct {
  ...
  description: string; specifications: Specifications; images: string[]; soldOut: boolean; hidden: boolean; bestSeller: boolean; badge: string | null;
}
...
const SEED_PRODUCTS: SeedProduct[] = [
  {
    ...
    images: [], soldOut: false, hidden: false, bestSeller: false, badge: null,
  },
  {
