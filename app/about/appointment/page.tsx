    ...
    <div className="min-h-screen px-4 py-12" style={{ backgroundColor: "var(--ivory)" }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white p-8" style={{ border: "1px solid var(--border)" }}>
          ...
          {section.body ? (
            <p className="text-sm font-sans whitespace-pre-line leading-relaxed mb-6" style={{ color: "var(--charcoal)" }}>
              {section.body}
            </p>
          ) : (
            <p className="text-sm font-sans mb-6" style={{ color: "var(--muted)" }}>ยังไม่มีเนื้อหา</p>
          )}
